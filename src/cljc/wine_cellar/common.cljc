...
(def technical-data-keys
  [:soil :vine-age :harvest :fermentation :aging :elevage :notes :vintner-notes
   :cooperage :oak :new-oak :yeast :malo-lactic :fining :filtration :ph
   :total-acidity :residual-sugar :base-vintage :reserve-wines :bottling-date
   :release-date :production-volume :certification])
